...
class Photo2Cartoon:
    def __init__(self):
        self.cartoon_net = onnxruntime.InferenceSession('Photo2Cartoon_fp32.onnx')
        self.head_seg_net = onnxruntime.InferenceSession('minivision_head_seg.onnx')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgpath', type=str, default='./1.jpg', help='input photo path')
